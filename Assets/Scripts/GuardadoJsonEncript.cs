...
public class GuardadoJsonEncript : MonoBehaviour
{
    ...
    public class SaveData
    {
        ...
        public SaveData(int _puntos, int _tiempo)
        {
    ...
    void Update()
    {
        ...
        {
            puntos = HUDManager.GetComponent<PuntosyTiempo>().puntos;
            tiempo = (int)HUDManager.GetComponent<PuntosyTiempo>().tiempo;

            //Instanciamos la clase anidada pasándole por parámetro las variables que queremos guardar
            SaveData sd = new SaveData(puntos, tiempo);
        ...
        if (Input.GetKeyDown(KeyCode.L))
        {
            ...
            puntos = sd.puntos;
            tiempo = sd.tiempo;
            playerposition = sd.playerposition;
            
            HUDManager.GetComponent<PuntosyTiempo>().puntos = puntos;
            HUDManager.GetComponent<PuntosyTiempo>().tiempo = tiempo;
